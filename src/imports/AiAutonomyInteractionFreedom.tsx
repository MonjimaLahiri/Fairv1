import svgPaths from "./svg-3jyt9f857p";

function Group3() {
  return (
    <div className="absolute contents leading-[24px] left-[507px] text-[#454545] top-[642px] tracking-[0.15px]">
      <p className="absolute font-['Albert_Sans:Italic',sans-serif] font-normal italic left-[507px] text-[16px] top-[671px]">Control which data pools the AI can use for context</p>
      <p className="absolute font-['Albert_Sans:Medium',sans-serif] font-medium left-[507px] text-[24px] top-[642px]">Contextual Scope</p>
    </div>
  );
}
...
function ArrowDropDown() {
  return (
    <div className="absolute left-[1403px] size-[24px] top-[654px]" data-name="arrow_drop_down">
...
function Group2() {
  return (
    <div className="absolute contents left-[1216px] top-[654px]">
      <p className="absolute font-['Albert_Sans:Medium',sans-serif] font-medium leading-[24px] left-[1216px] text-[#1e1e1e] text-[18px] top-[654px] tracking-[0.15px]">Current Session Only</p>
      <ArrowDropDown />
    </div>
  );
}
...
function Dropdown() {
  return (
    <div className="absolute contents left-[1199px] top-[646px]" data-name="dropdown">
      <div className="absolute bg-[#f0f4ff] border border-[#6786e2] border-solid h-[41px] left-[1199px] rounded-[5px] top-[646px] w-[244px]" />
      <Group2 />
    </div>
  );
}
...
function Box2() {
  return (
    <div className="absolute contents left-[486px] top-[620px]" data-name="box 3">
      <div className="absolute bg-white h-[156px] left-[486px] rounded-[5px] shadow-[0px_137px_38px_0px_rgba(200,200,200,0),0px_88px_35px_0px_rgba(200,200,200,0.01),0px_49px_30px_0px_rgba(200,200,200,0.05),0px_22px_22px_0px_rgba(200,200,200,0.09),0px_5px_12px_0px_rgba(200,200,200,0.1)] top-[620px] w-[992px]" />
      <p className="absolute font-['Albert_Sans:Regular',sans-serif] font-normal leading-[24px] left-[507px] text-[#696372] text-[16px] top-[741px] tracking-[0.15px]">AI only uses the current chat history, ignores saved goals and long term memory</p>
      <Group3 />
      <Dropdown />
      <div className="absolute h-0 left-[505px] top-[733px] w-[938.001px]">
...
function Group4() {
  return (
    <div className="absolute contents leading-[24px] left-[507px] text-[#454545] top-[461px] tracking-[0.15px]">
      <p className="absolute font-['Albert_Sans:Italic',sans-serif] font-normal italic left-[507px] text-[16px] top-[490px]">Enable advanced ‘undo’ capabilities and roll back to multi step actions</p>
      <p className="absolute font-['Albert_Sans:Medium',sans-serif] font-medium left-[507px] text-[24px] top-[461px]">Session Reversibility and Undo</p>
    </div>
  );
}
...
function ToggleSwitch() {
  return (
    <div className="absolute bg-[#34c759] content-stretch flex items-center justify-between left-[1379px] overflow-clip p-[2px] rounded-[100px] top-[467px] w-[64px]" data-name="Toggle - Switch">
      <Frame />
      <Knob />
    </div>
  );
...
function Box1() {
  return (
    <div className="absolute contents left-[486px] top-[439px]" data-name="box 2">
      <div className="absolute bg-white h-[129px] left-[486px] rounded-[5px] shadow-[0px_116px_33px_0px_rgba(200,200,200,0),0px_74px_30px_0px_rgba(200,200,200,0.01),0px_42px_25px_0px_rgba(200,200,200,0.05),0px_19px_19px_0px_rgba(200,200,200,0.09),0px_5px_10px_0px_rgba(200,200,200,0.1)] top-[439px] w-[992px]" />
      <Group4 />
      <ToggleSwitch />
    </div>
  );
...
function Group5() {
  return (
    <div className="absolute contents leading-[24px] left-[507px] text-[#454545] top-[253px] tracking-[0.15px]">
      <p className="absolute font-['Albert_Sans:Italic',sans-serif] font-normal italic left-[507px] text-[16px] top-[282px]">Adjust how proactively the AI acts</p>
      <p className="absolute font-['Albert_Sans:Medium',sans-serif] font-medium left-[507px] text-[24px] top-[253px]">AI Initiative Level</p>
    </div>
  );
}
...
function ArrowDropDown1() {
  return (
    <div className="absolute left-[1403px] size-[24px] top-[265px]" data-name="arrow_drop_down">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="arrow_drop_down">
          <path d="M12 15L7 10H17L12 15Z" fill="var(--fill-0, #1D1B20)" id="icon" />
        </g>
...
function Group6() {
  return (
    <div className="absolute contents left-[1216px] top-[265px]">
      <p className="absolute font-['Albert_Sans:Medium',sans-serif] font-medium leading-[24px] left-[1216px] text-[#1e1e1e] text-[18px] top-[265px] tracking-[0.15px]">Co-Pilot (Default)</p>
      <ArrowDropDown1 />
    </div>
  );
}
...
function Dropdown1() {
  return (
    <div className="absolute contents left-[1199px] top-[257px]" data-name="dropdown">
      <div className="absolute bg-[#f0f4ff] border border-[#6786e2] border-solid h-[41px] left-[1199px] rounded-[5px] top-[257px] w-[244px]" />
      <Group6 />
    </div>
  );
}
...
function Box() {
  return (
    <div className="absolute contents left-[486px] top-[231px]" data-name="box 1">
      <div className="absolute bg-white h-[156px] left-[486px] rounded-[5px] shadow-[0px_83px_23px_0px_rgba(200,200,200,0),0px_53px_21px_0px_rgba(200,200,200,0.01),0px_30px_18px_0px_rgba(200,200,200,0.05),0px_13px_13px_0px_rgba(200,200,200,0.09),0px_3px_7px_0px_rgba(200,200,200,0.1)] top-[231px] w-[992px]" />
      <p className="absolute font-['Albert_Sans:Regular',sans-serif] font-normal leading-[24px] left-[507px] text-[#696372] text-[16px] top-[352px] tracking-[0.15px]">Co-Pilot mode: AI assists, drafts, offers suggestions, but needs consent</p>
      <Group5 />
      <Dropdown1 />
      <div className="absolute h-0 left-[505px] top-[344px] w-[938.001px]">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 938.001 1">
            <line id="Line 14" stroke="var(--stroke-0, #696372)" x2="938.001" y1="0.5" y2="0.5" />
          </svg>
...
function OcticonGoal({ className }: { className?: string }) {
  return (
    <div className={className || "-translate-y-1/2 absolute left-[45px] size-[40px] top-[calc(50%-26.5px)]"} data-name="octicon:goal-24">
      <div className="absolute inset-[5.67%_5.67%_42.2%_42.19%]" data-name="Vector">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20.8538 20.8538">
          <path d={svgPaths.p2dbb1100} fill="var(--fill-0, #1E1E1E)" id="Vector" stroke="var(--stroke-0, #F5F7FA)" strokeWidth="0.5" />
        </svg>
      </div>
      <div className="absolute inset-[4.69%]" data-name="Vector">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 36.25 36.25">
          <path d={svgPaths.p194ab000} fill="var(--fill-0, #1E1E1E)" id="Vector" stroke="var(--stroke-0, #F5F7FA)" strokeWidth="0.5" />
        </svg>
      </div>
      <div className="absolute inset-[23.44%_23.44%_23.42%_23.44%]" data-name="Vector">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 21.2479 21.2549">
          <path d={svgPaths.p2ceb100} fill="var(--fill-0, #1E1E1E)" id="Vector" stroke="var(--stroke-0, #F5F7FA)" strokeWidth="0.5" />
        </svg>
      </div>
    </div>
  );
    ...
    <div className="absolute inset-[8.33%_12.5%]" data-name="Group">
      <div className="absolute inset-[-2.25%_-2.5%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 31.5 34.8334">
          <g id="Group">
            <path d={svgPaths.p29512ea0} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeWidth="1.5" />
            <path d={svgPaths.p20fd70f1} id="Vector_2" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
            <path d={svgPaths.p333aa780} id="Vector_3" stroke="var(--stroke-0, white)" strokeWidth="1.5" />
          </g>
        </svg>
      </div>
    </div>
...
function ButtnAutonomy() {
  return (
    <div className="absolute contents left-[26px] top-[283px]" data-name="buttn autonomy">
      <div className="absolute bg-[#6155f5] h-[61px] left-[26px] rounded-[31px] top-[283px] w-[355px]" />
      <HugeiconsAiInnovation />
      <p className="absolute font-['Albert_Sans:Regular',sans-serif] font-normal leading-[0] left-[103px] text-[20px] text-white top-[calc(50%-246.5px)] tracking-[0.15px]">
        <span className="font-['Albert_Sans:Medium',sans-serif] font-medium leading-[24px]">AI Autonomy</span>
        <span className="leading-[24px]">{` `}</span>
        <span className="font-['Open_Sans:Regular',sans-serif] leading-[24px]" style={{ fontVariationSettings: "\'wdth\' 100" }}>{`&`}</span>
        <span className="leading-[24px]">{` `}</span>
        <span className="font-['Albert_Sans:Medium',sans-serif] font-medium leading-[24px]">Interaction</span>
      </p>
    </div>
  );
}
...
export default function AiAutonomyInteractionFreedom() {
  return (
    <div className="bg-[#fffffb] overflow-clip relative rounded-[24px] size-full" data-name="AI Autonomy & Interaction (Freedom)">
      <Box2 />
      <Box1 />
      <Box />
      <p className="absolute font-['Albert_Sans:Regular',sans-serif] font-normal leading-[24px] left-[486px] text-[34px] text-black top-[66px] tracking-[0.15px]">AI Autonomy and Interaction</p>
      <p className="absolute font-['Albert_Sans:Regular',sans-serif] font-normal leading-[24px] left-[486px] text-[#454545] text-[20px] top-[122px] tracking-[0.15px]">{`Control how much the AI acts on own, and how your personal data is used. `}</p>
      <NavPanel />
      <Group7 />
    </div>
  );
